...
public class InputBenchmark {
	...
	@Benchmark
	public void benchmarkChained(FlinkEnvironmentContext context) throws Exception {
	...
	@Benchmark
	public void benchmarkChannel(FlinkEnvironmentContext context) throws Exception {
